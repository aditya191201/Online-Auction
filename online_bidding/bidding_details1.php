...
<body style="background-color: rgb(255, 236, 219);">
    <nav>
        ...
        <ul>
            ...
            <li><a class = "active" href="bidding_details1.php">BIDDING DETAILS</a></li>
    ...
    <div class="first">
        ...
        <h1 style="font-size: 2.5em; text-align:center; font-family: 'Poppins', sans-serif; color: #004094;">BIDS LIST</h1>
   <br><br>
        <form action="add_product_code.php" method="post" enctype="multipart/form-data" name="form3" id="form3">
          <table width="100%" border="0" style="text-align: center; justify-content: center;">
   ...
   ?>
     ...
     <td><a href='view_bids1.php?id=$id'>Details</a></td>
          ";?>
       </tr>
