...
<body style="background-color: rgb(255, 236, 219);">
    <nav>
        ...
        <ul>
            ...
            <li><a class="active" href="my_order1.php" >MY PURCHASES</a></li>
...
<table width="90%" border="0" style="text-align: center; padding-left: 150px;">
  <tr style="font-size: 1.8em; font-weight: bold;">
    <td width="26%" height="23">PRODUCT NAME</td>
    <td width="23%">BASE PRICE</td>
    <td width="20%">PURCHASE PRICE</td>
    
  </tr>
   <?php
    include('database.php');
   $s=mysqli_query($con,"select * from sold_products where email='$ses'");
