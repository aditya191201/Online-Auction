...
<body style="background-color: rgb(255, 236, 219);">
    ...
    <div>
     ...
     <h1 style="font-size: 2.5em; text-align:center; font-family: 'Poppins', sans-serif; color: #004094;">SELECT YOUR PRODUCTS TO BIDDING</h1>
<br><br>
     <form id="form3" name="form3" method="post" action="">
       <table width="70%" border="0" cellspacing="5" style="text-align: center; padding-left: 440px">
         <tr>
         <?php
...
while($row=mysqli_fetch_array($s))
{
		 ?>
           ...
           <td width="10%" height="121" rowspan="2"><img src="upload/<?php echo $row['image']; ?>" alt="" width="150" height="150" /></td>
           <td width="12%" height="58" style="font-size: 1.3em;"><h3><?php echo $row['p_name']; ?></h3><?php echo $row['price']; ?></td>
          </tr>
         <tr>
           <td height="58" style="font-size: 1.1em;"><a href="bidding1.php?id=<?php echo $row['p_id']; ?>">Click here to Bid</a></td>
         </tr>
            <?php
}
