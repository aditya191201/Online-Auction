...
<br><br>
    <div>
     ...
     <h1 style="font-size: 2.5em; text-align:center; font-family: 'Poppins', sans-serif; color: #004094; padding-left: 100px;">BIDDING DETAILS</h1>
...
?>
     ...
     <table width="90%" border="0" style="text-align: center; padding-left: 200px; ">
       ...
       <td width="24%"><h4>Product Name</h4></td>
         <td width="24%"><h4>BIDDER NAME</h4></td>
